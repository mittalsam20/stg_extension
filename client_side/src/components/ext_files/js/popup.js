$(document).ready(function(){
    ...
    chrome.storage.sync.get(null, function(result) {
        console.log( (new Date()).getHours() ,(new Date()).getMinutes() , (new Date()).getSeconds(), (new Date()).getMilliseconds(), "chrome.storage.sync.get ")
    ...
    // Start recording
    function record(){
        console.log((new Date()).getHours() ,(new Date()).getMinutes() , (new Date()).getSeconds(), (new Date()).getMilliseconds(),"popup.js-->record()")
    ...
    function audioRequest() {
        console.log((new Date()).getHours() ,(new Date()).getMinutes() , (new Date()).getSeconds(), (new Date()).getMilliseconds(),"popup.js-->audioRequest()")
    ...
    function getAudio(audio) {
        console.log((new Date()).getHours() ,(new Date()).getMinutes() , (new Date()).getSeconds(), (new Date()).getMilliseconds(),"popup.js-->getAudio(audio)")
    ...
    //     console.log((new Date()).getHours() ,(new Date()).getMinutes() , (new Date()).getSeconds(), (new Date()).getMilliseconds(),"popup.js-->getCamera(camera)")
    ...
    chrome.tabs.getSelected(null, function(tab) {
        console.log((new Date()).getHours() ,(new Date()).getMinutes() , (new Date()).getSeconds(), (new Date()).getMilliseconds(),"popup.js--> chrome.tabs.getSelected(null, function(tab)")
    ...
    chrome.runtime.sendMessage({type: "record-request"}, function(response){
        console.log((new Date()).getHours() ,(new Date()).getMinutes() , (new Date()).getSeconds(), (new Date()).getMilliseconds(),'popup.js--> chrome.runtime.sendMessage({type: "record-request"}')
    ...
    chrome.tabs.query({active: true, lastFocusedWindow: true}, tabs => {
        console.log((new Date()).getHours() ,(new Date()).getMinutes() , (new Date()).getSeconds(), (new Date()).getMilliseconds(),'popup.js-->  chrome.tabs.query({active: true, lastFocusedWindow: true}')

        
    //     if (!tabs[0].url.includes("https://meet.google.com/") || tabs[0].url == "https://meet.google.com" || tabs[0].url == "https://meet.google.com/") {
    //         console.log(tabs[0].url == "https://meet.google.com/")
    ...
    //     console.log((new Date()).getHours() ,(new Date()).getMinutes() , (new Date()).getSeconds(), (new Date()).getMilliseconds(),'popup.js-->  $("#flip").on("change",')
    ...
    //     console.log((new Date()).getHours() ,(new Date()).getMinutes() , (new Date()).getSeconds(), (new Date()).getMilliseconds(),'popup.js-->  $("#push").on("change",')
    ...
    //     console.log((new Date()).getHours() ,(new Date()).getMinutes() , (new Date()).getSeconds(), (new Date()).getMilliseconds(),'popup.js-->  $("#countdown").on("change",')

    //     chrome.storage.sync.set({countdown: this.checked});
    // });
    // $("#persistent").on("change", function(){
    //     console.log((new Date()).getHours() ,(new Date()).getMinutes() , (new Date()).getSeconds(), (new Date()).getMilliseconds(),'popup.js-->  $("#persistent").on("change",')

    //     chrome.storage.sync.set({toolbar: !this.checked});
    //     chrome.runtime.sendMessage({type: "switch-toolbar", enabled:!this.checked});
    // });
    // $("#camera-select").on("change", function(){
    //     console.log((new Date()).getHours() ,(new Date()).getMinutes() , (new Date()).getSeconds(), (new Date()).getMilliseconds(),'popup.js-->  $("#camera-select").on("change",')
    ...
    $("#mic-select").on("change", function(){
        console.log((new Date()).getHours() ,(new Date()).getMinutes() , (new Date()).getSeconds(), (new Date()).getMilliseconds(),'popup.js-->  $("#mic-select").on("change",')
    ...
    $(document).on("click", ".type:not(.type-active)", function(){
        console.log((new Date()).getHours() ,(new Date()).getMinutes() , (new Date()).getSeconds(), (new Date()).getMilliseconds(),'popup.js-->  $(document).on("click", ".type:not(.type-active)"')
    ...
    $("#record").on("click", function(){
        console.log((new Date()).getHours() ,(new Date()).getMinutes() , (new Date()).getSeconds(), (new Date()).getMilliseconds(),'popup.js-->  $("#record").on("click",')
    ...
    //     console.log((new Date()).getHours() ,(new Date()).getMinutes() , (new Date()).getSeconds(), (new Date()).getMilliseconds(),'popup.js-->  $("#more").on("click",')
    ...
    //     console.log((new Date()).getHours() ,(new Date()).getMinutes() , (new Date()).getSeconds(), (new Date()).getMilliseconds(),'popup.js-->  $("#awards").on("click",')
    ...
    //     console.log((new Date()).getHours() ,(new Date()).getMinutes() , (new Date()).getSeconds(), (new Date()).getMilliseconds(),'popup.js-->  $("#count-select").on("click",')
    ...
    //     console.log((new Date()).getHours() ,(new Date()).getMinutes() , (new Date()).getSeconds(), (new Date()).getMilliseconds(),'popup.js-->  $(".countdown").on("click",')
    ...
    //     console.log((new Date()).getHours() ,(new Date()).getMinutes() , (new Date()).getSeconds(), (new Date()).getMilliseconds(),'popup.js-->  $(document).on("click", function(e)')
    ...
    //     console.log((new Date()).getHours() ,(new Date()).getMinutes() , (new Date()).getSeconds(), (new Date()).getMilliseconds(),'popup.js-->  $("#shortcuts").on("click",')
    ...
    //     console.log((new Date()).getHours() ,(new Date()).getMinutes() , (new Date()).getSeconds(), (new Date()).getMilliseconds(),'popup.js-->  $("#quality").on("click",')
    ...
    //     console.log((new Date()).getHours() ,(new Date()).getMinutes() , (new Date()).getSeconds(), (new Date()).getMilliseconds(),'popup.js-->  $("#fps").on("click",')
    ...
    chrome.runtime.onMessage.addListener(function(request, sender, sendResponse) {
        console.log((new Date()).getHours() ,(new Date()).getMinutes() , (new Date()).getSeconds(), (new Date()).getMilliseconds(),'popup.js-->  chrome.runtime.onMessage.addListener(function(request, sender, sendResponse)' , request.type )
