        ...
        <div className="back_img_div">
          <div className="inner_why">
            ...
            <ul>
              ...
              <li>
                CHANNELISE YOUR ENERGY IN TASKS THAT CREATES VALUE
                <br />
                <strong>(NO NEED TO TAKE WRITTEN NOTES OF MEETINGS).</strong>
              </li>
            </ul>
          </div>
        </div>
